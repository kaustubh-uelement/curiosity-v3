    ...
    <div className={cn("flow-container relative my-6", className)}>
      ...
      <div className="flow relative grid grid-cols-1 lg:grid-cols-[1fr_260px_1fr] gap-6 sm:gap-8 items-center">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isHovered
                    ? "border-orchid/80 bg-white/[0.08] shadow-[0_0_24px_rgba(205,130,255,0.2)] -translate-x-1 text-white"
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isHovered
                      ? "bg-orchid text-ink shadow-[0_0_12px_rgba(205,130,255,0.6)]"
        ...
        <div
          ...
          className="fCore relative z-20 flex flex-col items-center justify-center p-6 sm:p-8 rounded-3xl border border-white/30 bg-gradient-to-b from-electric via-violet to-ink-2 shadow-[0_0_60px_rgba(69,0,249,0.45)] transition-all duration-500 hover:shadow-[0_0_90px_rgba(205,130,255,0.6)] hover:scale-[1.03] overflow-hidden text-center cursor-default"
        >
          {/* Animated Background Rays */}
          <div
            className="pointer-events-none absolute -inset-10 bg-[radial-gradient(circle_at_center,rgba(205,130,255,0.25)_0%,transparent_70%)] animate-pulseSlow"
            aria-hidden="true"
          />
            ...
            return (
              <div
                ...
                className={cn(
                  "fNode group relative flex items-center gap-3.5 p-3.5 sm:p-4 rounded-xl border transition-all duration-300 cursor-pointer overflow-hidden",
                  isHovered
                    ? "border-violet/80 bg-white/[0.08] shadow-[0_0_24px_rgba(135,82,250,0.2)] translate-x-1 text-white"
                    : "border-white/10 bg-white/[0.025] hover:border-white/25 text-tx-2"
                )}
              >
                {/* Accent indicator bar */}
                ...
                <span
                  className={cn(
                    "flex-none flex items-center justify-center w-7 h-7 rounded-lg transition-all duration-300",
                    isHovered
                      ? "bg-violet text-white shadow-[0_0_12px_rgba(135,82,250,0.6)]"
