...
const variantMap = {
  ...
  pill:
    "pillTag inline-flex items-center py-3 px-5 rounded-r-pill text-sm text-tx-2 border border-line bg-glass backdrop-blur-[20px] transition-all duration-300 hover:border-line-2 hover:text-tx hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(56,189,248,0.15)] cursor-default select-none",
  spec:
