...
export const SITE = {
  name: "Curiosity AI",
  tagline: "Compute AI Infrastructure Platform for Abundant Intelligence.",
  hero: "Compute with an Edge",
  intro:
    "Curiosity AI is the full-stack compute infrastructure platform bringing megawatt-scale AI capacity online — partnering with AI Factories to serve large-scale neo-clouds and enterprise AI.",
  address: "Vaswani Chambers, Worli, Mumbai, India",
  email: {
    deploy: "deploy@curiosityai.in",
    factories: "factories@curiosityai.in",
    hello: "hello@curiosityai.in",
  },
};
...
/* Hero announcement — SharpLink's "COMPANY NEWS" card */
...
/* Live capacity strip — SharpLink's ETH holdings dashboard */
export const DASHBOARD = [
  { label: "Live capacity", value: 5, unit: "MW", note: "Phase 1 · Sept 2026 – Mar 2027", live: true },
  { label: "GPUs deployed", value: 2304, note: "4 × SuperPOD clusters" },
  { label: "Target capacity", value: 100, unit: "MW+", note: "Phased through 2029" },
  { label: "AI Factory partners", value: 6, note: "Mumbai & Chennai" },
];

/* "Pioneering Productivity" equivalent — 01/02/03 */
...
/* Sticky stacking cards — SharpLink's "The Stack" propositions */
export const STACK = [
  {
    kicker: "Sourcing",
...
/* "The Opportunity of a Generation" equivalent */
export const OPPORTUNITY = [
  ...
  },
  {
    ...
    body: "AI-ready data centres in Mumbai and Chennai now have the power and institutional capability to host frontier-scale compute — and the capital to scale it.",
  },
  {
...
export const MARKET = [
  { value: "$200", unit: "B+", label: "Cumulative contracted backlog across leading global neo-clouds." },
  { value: "$104", unit: "B", label: "CoreWeave's contracted AI compute backlog." },
  { value: "40×", label: "CoreWeave backlog relative to quarterly revenue." },
  { value: "1", unit: "GW+", label: "Near-term capacity pipelines among global peers." },
];
