...
export const GPUS = [
  {
    ...
    image: "/products/nvidia-blackwell-b300.jpg",
    specs: [
      "Architecture: NVIDIA Blackwell",
      "Interconnect: Quantum-X800 InfiniBand",
      "Memory: High-Bandwidth HBM3e",
  ...
  },
  {
    ...
    image: "/products/nvidia-gb300-nvl72.jpg",
    specs: [
      "Architecture: Grace Blackwell NVL72",
      "Cooling: Direct-to-Chip Liquid",
      "Bandwidth: 130 TB/s NVLink Fabric",
      "Availability: Q2 CY2027",
    ],
  },
  {
    tag: "OPEN SOVEREIGN COMPUTE",
    name: "AMD Instinct MI325X Cluster",
    ...
    image: "/products/amd-instinct-mi325x.jpg",
    specs: [
      "Architecture: AMD CDNA 3 / 4",
      "VRAM: 256GB HBM3e / OAM",
      "Network: Ultra Ethernet Consortium (UEC)",
      "Availability: Active Roadmap",
    ],
  },
];
